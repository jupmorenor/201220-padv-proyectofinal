    ...
    <h1><center>
      Administrar Conductores
        ...
        <div>
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                ...
                <p>
                  ...
                  <input type="image" name="request-Delete" id="frm-request-delete" src="/eliminar.jpg" alt="delete" value="delete">
                </p>
              </form></td>
            </tr>
            <tr>
          ...
          <input type="image" name="request-submit" id="frm-request-submit" src="/btn-submit-large.png" alt="Submit" value="Submit" readonly disabled ="disabled"></p>
              </form></td>
            </tr>
            <tr>
              <td style="font-size: medium"><center>
