            ...
            <tr>
              ...
              <td width="382" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  ...
                  <input type="text" name="textcodRuta" id="textcodRuta">
                </p>
                <p>
                  <label for="textnombreRuta">Nombre Ruta</label>
                  <input type="text" name="textnombreRuta" id="textnombreRuta">
                </p>
                <p>      
                ...
                <p> 
                  ...
                  <input type="text" name="texttarifaRuta2" id="tarifaRuta">
                </p>
                <p>
