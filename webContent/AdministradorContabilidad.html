...
<head>
<meta charset="utf-8">
<title>Administrar Contabilidad</title>
<style type="text/css">
<!--
body {
  ...
  <div class="content">
    <h1><center>
          ...
          <tr>
            ...
            <td><img src="contabilidad.gif" width="120" height="90"></td>
          </tr>
        </table>
        <hr>
        <p>&nbsp;</p>
        <div>
          <table width="648" border="1" cellspacing="2">
            <tr>
              ...
              <td width="406" style="font-size: medium"><form name="form2" method="post" action="">
                <p>&nbsp;</p>
              </form></td>
            </tr>
          </table>
