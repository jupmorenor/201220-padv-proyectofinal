...
<head>
<meta charset="utf-8">
<title>Consultar Informacion Usuarios</title>
<style type="text/css">
<!--
  ...
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><strong><center>Consultar Información</center></strong></li>
        ...
        <li><a href="UsuarioConsultarInfo.jsp"><left>Consultar Informacion Personal</left></a></li>
      <p>
  ...
  <div class="content">
    <h1><center>
      ...
      <div id="aside">
					<div class="box-b">
						<div>
						  <h3> <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: medium;">Consultar Información Personal</span></h3><form id="frm-request" action="/" method="post">
								<fieldset>
								  <p>
								    <label class="w3c" for="frm-email2">Leave blank</label>
								    <input class="w3c" type="text" name="email2" id="frm-email2" value="">
								    <label><span style="font-size: medium">Identificación</span></label>
