...
<head>
<meta charset="utf-8">
<title>Registrar Informacion Usuario</title>
<style type="text/css">
<!--
					...
					<div class="box-b">
						<div>
						  ...
						  <span class="tituloRegistro"><center spry:hover="titulod">
						    <p class="box-b"><center style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: medium;">Registre su Información</center> </p>
								...
								<fieldset>
									<p>
									  ...
									  <label for="frm-request-name">Identificación</label>
									  </span><span style="font-size: medium">
									  <input type="text" name="identificacion" id="frm-request-name" value="">
							          </span><span style="font-size: medium">
							          <label for="frm-request-email">Nombre</label>
							          </span><span style="font-size: medium">
								  <input type="text" name="nombre" id="frm-request-email" value="">
								  </input>
								  <label for="frm-request-phone">Telefono</label>
								      </span><span style="font-size: medium">
								  <input type="text" name="telefono" id="frm-request-phone" value="">
				                  </span></p>
									<p><span style="font-size: medium">
								    <label for="frm-request-company">Direccion</label>
									</span><span style="font-size: medium">
								    <input type="text" name="direccion" id="frm-request-company" value="">
								    </input>
						          </span></p>
									<p>
									  <span style="font-size: medium">
