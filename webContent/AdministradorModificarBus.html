            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                ...
                <p>
                  ...
                  <input name="textCodigoInterno" type="text" disabled="disabled" id="nombRuta" readonly="readonly">
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="form1" method="post" action="">
                ...
                <p>
                  ...
                  <input name="textCodInternoBus" type="text" id="textCodInternoBus">
              </p>
                <p>      
                  <label for="textCapacidadBus">Capacidad</label>
                  <input name="textCapacidadBus" type="text" id="tarifaRuta2">
                </p>
                <p>
                  <input type="image" name="request-submit" id="frm-request-submit" src="/btn-submit-large.png" alt="Submit" value="Submit">
              </p>
