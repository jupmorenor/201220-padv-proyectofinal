...
<head>
<meta charset="utf-8">
<title>Modificar Informacion Empleado</title>
<style type="text/css">
<!--
  ...
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><strong><p></p></strong></li>
      	<li><a href="#"><strong><center>Consultar Programación Diaria</center></strong></a></li>
        <p></p>
        <li><a href="EmpleadoConsultarInfo.jsp"><strong><center>Consultar Informacion Personal</center></strong></a></li>
        <p></p>
        <li><a href="EmpleadoModificarInfo.jsp"><strong><center>Modificar Informacion Personal</center></strong></a></li>
    </ul>
					...
					<div class="box-b">
						<div>
						  ...
						  <span class="tituloRegistro"><center spry:hover="titulod">
						    <p class="box-b"><center style="font-size: medium">Registre su Información</center> </p>
						  </center></span></h3><form id="frm-request" action="/" method="post">
								<fieldset>
									<p>
									  	<label for="frm-request-name"><span style="font-size: medium">Identificación</span></label>
									  	<span style="font-size: medium">
									  	</input>
									  	<input type="text" name="identificacion" id="identificacion" value=""></input>
									    <label for="frm-request-email"><br>
								        Nombre</label>
					  	          </span></p>
									<p>
									  <span style="font-size: medium">
									  <input type="text" name="nombre" id="frm-request-nombre" value="">
									  </input>
									  <label for="frm-request-phone"><br>
								      Telefono</label>
							      </span></p>
									<p>
									  <span style="font-size: medium">
									  <input type="text" name="telefono" id="frm-request-telefono" value="">
									  </input>
									  <label for="frm-request-company"><br>
								      Direccion</label>
								  </span></p>
									<p><span style="font-size: medium">
								    <input type="text" name="direccion" id="frm-request-direccion" value="">
								    </input>
								    </span></p>
									<p>
									  <span style="font-size: medium">
									  <label for="frm-request-company" >Fecha de Nacimiento</label>
									  <input type="date" name="fechaNacimiento" id="frm-request-fecha-nacimiento" value="">
							      </span></p>
									<p>
									  <span style="font-size: medium">
									  <label for="frm-request-licencia">Licencia de Conducción</label>
									  <input type="date" name="licencia" id="frm-request-licencia" value="">
									  </input>
							      </span></p>
									<p>&nbsp;</p>
									<p>
