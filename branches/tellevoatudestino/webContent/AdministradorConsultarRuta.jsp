            ...
            <tr>
              ...
              <td width="382" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  ...
                  <input name="textcodRuta" type="text" disabled="disabled" id="textcodRuta" readonly>
                </p>
                <p>
                ...
                <p>
                  <input type="image" name="request-submit" id="frm-request-submit" src="/btn-submit-large.png" alt="Submit" value="Submit" disabled="disabled" readonly>
                </p>
              </form></td>
            </tr>
            <tr>
