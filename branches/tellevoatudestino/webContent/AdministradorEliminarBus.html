          ...
          <table width="657" cellspacing="2">
            <tr>
              ...
              <td width="412" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  ...
                  <input name="textcodBus" type="text" disabled="disabled" id="textcodBus" readonly>
                </p>
                <p>
                  <label for="textCapacidad">Capacidad</label>
                  <input name="textCapacidad" type="text" disabled="disabled" id="textCapacidad" readonly>
                </p>
                <p><label for="textPlaca">Placa</label> 
                  <input name="textPlaca" type="text" disabled="disabled" id="textPlaca" readonly>
                </p>
                <p>
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="form2" method="post" action="">
                ...
                <input name="textComsumo" type="text" disabled="disabled" id="textComsumo" readonly></p>
              </form></td>
            </tr>
          </table>
          <p>&nbsp;</p>
