    ...
    <ul class="nav">
      ...
      <p></p>
        ...
        <li><strong><center>Administrar Sucursales</center></strong></li>
      	<li><a href="AdministradorAgregarSucursal.jsp"><center>Agregar Sucursal</center></a></li>
        <li><a href="AdministradorEliminarSucursal.jsp"><center>Eliminar Sucursal</center></a></li>
        <li><a href="AdministradorModificarSucursal.jsp"><center>Modificar Sucursal</center></a></li>
        <li><a href="AdministradorConsultarSucursal.jsp"><center>Consultar Sucursal</center></a></li>		
        <p></p>
    ...
    <h1><center>
      Administrar Conductores
          ...
          <tr>
            ...
            <td><img src="Bus-Driver.gif" width="133" height="126"></td>
          </tr>
        </table>
        <hr>
        <p>&nbsp;</p>
        <div>
          <table width="645" border="1" cellspacing="2">
            <tr>
              <td width="211" style="font-size: medium"><center>
                <strong>Agregar Conductor</strong>
              </center></td>
              <td width="418" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  <label for="textIdentificacionCond">Identificación</label>
                  <input name="textIdentificacionCond" type="text" disabled="disabled" id="textIdentificacionCond" readonly>
                </p>
                <p>
                  <label for="textnombreConductor">Nombre</label>
                  <input name="textnombreConductor" type="text" disabled="disabled" id="textnombreConductor" readonly>
                </p>
                <p>      
                  <label for="textTelefonoConductor">Teléfono</label>
                  <input name="textTelefonoConductor" type="text" disabled="disabled" id="tarifaRuta2" readonly>
                </p>
                <p> 
                  <label for="textTelefonoConductor">Dirección</label>
                  <input name="textDireecionConductor" type="text" disabled="disabled" id="tarifaRuta" readonly>
                </p>
                <p>
                  <label>Fecha de Nacimiento</label>
                <input type="date" name="fechaNacimiento" disabled="disabled" readonly>
                </p>
                <p>
                  <label for="textlicencia">Licencia</label>
                  <input name="textlicencia" type="text" disabled="disabled" id="textlicencia" readonly>
                </p>
                <p>
                  <input type="image" name="request-submit" id="frm-request-submit" src="/btn-submit-large.png" alt="Submit" value="Submit" disabled="disabled">
        </p>
              </form></td>
            </tr>
            <tr>
              <td style="font-size: medium"><center>
                <strong>Eliminar Conductor</strong>
              </center></td>
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                <p>
                  <label for="selecIdentifConductor">Identificación</label>
                  <select name="selecIdentifConductor" id="selecIdentifConductor" disabled="disabled">
                    <option value="0" selected="selected">Seleccione la Identificacion...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p>
                  <label for="textnombreConductor">Nombre</label>
                  <input name="textnombreConductor" type="text" disabled="disabled" id="textnombreConductor" readonly>
                  <input type="image" name="request-Delete" id="frm-request-delete" src="/eliminar.jpg" alt="delete" value="delete" disabled="disabled">
                </p>
              </form></td>
            </tr>
            <tr>
              ...
              <td style="font-size: medium"><form name="form1" method="post" action="">
                <p><label for="selecIdentifConductor">Identificación</label>
                  <select name="selecIdentifConductor" id="selecIdentifConductor">
                    <option value="0" selected="selected">Seleccione la Identificacion...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p><label for="textnombreConductor">Nombre</label>
                  <input name="textnombreConductor" type="text" id="textnombreConductor">
                </p>
                <p>      
                  <label for="texttarifaRuta">Teléfono</label>
                  <input name="texttarifaRuta" type="text" id="tarifaRuta2">
                </p>
                <p> 
                  <label for="texttarifaRuta">Dirección</label>
                  <input name="textDireccionConductor" type="text" id="tarifaRuta">
                </p>
                <p>
                  <label>Fecha de Nacimiento</label>
                ...
                <p>
                  <label for="textlicencia">Licencia</label>
                  <input name="textlicencia" type="text" id="textlicencia">
          </p></p>
          <input type="image" name="request-submit" id="frm-request-submit" src="/btn-submit-large.png" alt="Submit" value="Submit"></p>
            ...
            <tr>
              <td style="font-size: medium"><center>
                <strong>                Consultar Conductor
                </strong>
              </center></td>
              <td style="font-size: medium"><form name="form2" method="post" action="">
                <p><label for="selecIdentifConductor">Identificación</label>
                  <select name="selecIdentifConductor" id="selecIdentifConductor" disabled="disabled" readonly ="readonly">
                    <option value="0" selected="selected">Seleccione la Identificacion...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p><label for="textnombreConductor">Nombre</label>
                ...
                <p>      
                  <label for="texttarifaRuta">Teléfono</label>
                  <input name="texttarifaRuta" type="text" disabled="disabled" id="tarifaRuta2" readonly>
                </p>
                <p> 
                  <label for="texttarifaRuta">Dirección</label>
                  <input name="textDireccionConductor" type="text" disabled="disabled" id="tarifaRuta" readonly>
                </p>
                <p>
                  <label>Fecha de Nacimiento</label>
                  <input type="date" name="fechaNacimiento" disabled="disabled" readonly></input>
                </p>
                <p>
                  <label for="textlicencia">Licencia</label>
                  <input name="textlicencia" type="text" disabled="disabled" id="textlicencia" readonly></p>
              </form></td>
            </tr>
          </table>
          <p>&nbsp;</p>
