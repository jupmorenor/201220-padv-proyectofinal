  ...
  <div class="content">
    <h1><center>
      Administrar Ruta
        ...
        <p>&nbsp;</p>
        <div>
          <table width="627" cellspacing="2">
            <tr>
              <td width="233" style="font-size: medium"><center>Agregar Ruta</center></td>
              <td width="382" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  <label for="textcodRuta">Código Ruta</label>
                  <input name="textcodRuta" type="text" disabled="disabled" id="textcodRuta" readonly="readonly">
                </p>
                <p>
                  <label for="textnombreRuta">Nombre Ruta</label>
                  <input name="textnombreRuta" type="text" disabled="disabled" id="textnombreRuta" readonly="readonly">
                </p>
                <p>      
                  <label for="texttarifaRuta">Tarifa Ruta</label>
                  <input name="texttarifaRuta" type="text" disabled="disabled" id="tarifaRuta2" readonly="readonly">
                </p>
                <p> 
                  <label for="texttarifaRuta">Distancia Ruta</label>
                  <input name="texttarifaRuta2" type="text" disabled="disabled" id="tarifaRuta" readonly="readonly">
                </p>
                <p>
                  <input type="image" name="request-submit" id="frm-request-submit" src="/btn-submit-large.png" alt="Submit" value="Submit" disabled="disabled" readonly="readonly">
                </p>
              </form></td>
            </tr>
            <tr>
              <td style="font-size: medium"><center>Eliminar Ruta</center></td>
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                <p>
                  <label for="selecCodRuta">Código Ruta</label>
                  <select name="selecCodRuta" id="selecCodRuta" disabled="disabled" readonly ="readonly">
                    <option value="0">Seleccione la Ruta...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p>
                  <label for="textnombRuta">Nombre Ruta</label>
                  <input name="textnombRuta" type="text" disabled="disabled" id="nombRuta" readonly>
                  <input type="image" name="request-Delete" id="frm-request-delete" src="/eliminar.jpg" alt="delete" value="delete" disabled="disabled" readonly>
                </p>
              </form></td>
            </tr>
            <tr>
              <td style="font-size: medium"><center>Modificar Ruta</center></td>
              <td style="font-size: medium"><form name="form1" method="post" action="">
                <p>
                  ...
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p><label for="textnombreRuta">Nombre Ruta</label>
                  <input name="textnombreRuta" type="text" disabled="disabled" id="textnombreRuta" readonly>
              </p>
                <p>      
                  <label for="texttarifaRuta">Tarifa Ruta</label>
                ...
                <p> 
                  <label for="texttarifaRuta">Distancia Ruta</label>
                  <input name="texttarifaRuta2" type="text" disabled="disabled" id="tarifaRuta" readonly>
                </p>
                <p>
                  <input type="image" name="request-submit" id="frm-request-submit" src="/btn-submit-large.png" alt="Submit" value="Submit" readonly disabled ="disabled">
                </p>
              </form></td>
            </tr>
            <tr>
              <td style="font-size: medium"><center>Consultar Ruta</center></td>
              <td style="font-size: medium"><form name="form2" method="post" action="">
                <p>
                  <label for="selecCodRuta">Código Ruta</label>
                  <select name="selecCodRuta" id="selecCodRuta">
                    <option value="0">Seleccione la Ruta...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p>
                  <label for="textnombreRuta">Nombre Ruta</label>
                  <input name="textnombreRuta" type="text" id="textnombreRuta">
          </p>
                <p>      
                  <label for="texttarifaRuta">Tarifa Ruta</label>
                ...
                <p> 
                  <label for="texttarifaRuta">Distancia Ruta</label>
                  <input name="texttarifaRuta2" type="text" id="tarifaRuta">
                </p>
              </form></td>
            </tr>
          </table>
