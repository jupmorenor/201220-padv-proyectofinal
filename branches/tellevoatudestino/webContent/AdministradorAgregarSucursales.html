            ...
            <tr>
              ...
              <td width="406" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p>   <label for="textCodSucursal">Código Sucursal</label>
                  <input type="text" name="textCodSucursal" id="textIdenficiacionConductor">
                </p>
                <p>
                  <label for="textnombreSucursal">Nombre Sucursal</label>
                  <input type="text" name="textnombreSucursal" id="textnombreSucursal">
                </p>
                <p>      
                  <label for="textDireccion">Dirección Sucursal</label>
                  <input type="text" name="textDireccion" id="tarifaRuta2">
                </p>
                <p> 
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                ...
                <p>
                  ...
                  <input type="image" name="request-Delete" id="frm-request-delete" src="/eliminar.jpg" alt="delete" value="delete" disabled="disabled" readonly></p>
              </form></td>
            </tr>
            <tr>
              <td style="font-size: medium"><center>
