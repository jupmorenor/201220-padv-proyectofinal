        ...
        <div>
          <table width="657" cellspacing="2">
            <tr>
              ...
              <td width="412" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  <label for="textcodBus">Código Interno Bus</label>
                  <input name="textcodBus" type="text" disabled="disabled" id="textcodBus" readonly="readonly">
                </p>
                <p>
                  <label for="textCapacidad">Capacidad</label>
                  <input name="textCapacidad" type="text" disabled="disabled" id="textCapacidad" readonly="readonly">
                </p>
                <p><label for="textPlaca">Placa</label> 
                  <input name="textPlaca" type="text" disabled="disabled" id="textPlaca" readonly="readonly">
                </p>
                <p>
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                ...
                <p>
                  ...
                  <input name="textCodigoInterno" type="text" id="nombRuta">
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="form2" method="post" action="">
                ...
                <p>      
                  <label for="textCapacidadBus">Capacidad</label>
                  <input name="textCapacidadBus" type="text" disabled="disabled" id="tarifaRuta2" readonly></p>
                <p><label for="textComsumo">Consumo de Combustible</label>
                <input name="textComsumo" type="text" disabled="disabled" id="textComsumo" readonly="readonly"></p>
              </form></td>
            </tr>
          </table>
          <p>&nbsp;</p>
