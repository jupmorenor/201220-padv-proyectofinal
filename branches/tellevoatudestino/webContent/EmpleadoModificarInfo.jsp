						...
						<div>
						  ...
						  <span class="tituloRegistro"><center spry:hover="titulod">
						    <p class="box-b"><center>Registre su Información</center> </p>
								...
								<fieldset>
									<p>
									  <input type="text" name="identificacion" id="frm-request-identificacion" value="">
									  <label class="w3c" for="frm-email2">Leave blank</label>
									  <input class="w3c" type="text" name="email2" id="frm-email2" value=""></input>
									  <label for="frm-request-name" class="w3c">Identificación</label></input>
								  </p>
									<p>
									  <label for="frm-request-email" class="w3c">Nombre</label>
									  <input type="text" name="nombre" id="frm-request-nombre" value=""></input>
									  <label for="frm-request-phone" class="w3c">Telefono</label>
								  </p>
								  <p>
									  <input type="text" name="telefono" id="frm-request-telefono" value=""></input>
								  </p>
									<p>
									  <label for="frm-request-company" class="w3c">Direccion</label>
									  <input type="text" name="direccion" id="frm-request-direccion" value=""></input>
									  <label for="frm-request-company" class="w3c">DD/MM/YYYY</label>
								  </p>
									<p>
									  <input type="date" name="fechaNacimiento" id="frm-request-fecha-nacimiento" value="">
									  </input>
									  <label for="frm-request-company" class="w3c">Licencia de Conducción</label>
								  </p>
								  <p>
