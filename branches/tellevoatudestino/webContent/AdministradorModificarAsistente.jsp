    ...
    <h1><center>
      Administrar Asistentes
          ...
          <tr>
            ...
            <td><img src="asistente.gif" width="120" height="140"></td>
          </tr>
        </table>
        <hr>
        <p>&nbsp;</p>
          ...
          <table width="648" border="1" cellspacing="2">
            <tr>
              ...
              <td width="406" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  <label for="textIdenficiacionAsistente">Identificación</label>
                  <input name="textIdenficiacionAsistente" type="text" disabled="disabled" id="textIdenficiacionConductor" readonly>
                </p>
                <p>
                  <label for="textnombreAsistente">Nombre</label>
                  <input name="textnombreAsistente" type="text" disabled="disabled" id="textnombreAsistente" readonly>
                </p>
                <p>      
                  <label for="textTelefono">Teléfono</label>
                  <input name="textTelefono" type="text" disabled="disabled" id="tarifaRuta2" readonly>
                </p>
                <p> 
                  <label for="textDireccion">Dirección</label>
                  <input name="textDireccion" type="text" disabled="disabled" id="tarifaRuta" readonly>
                </p>
                <p>
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                <p>
                  <label for="selecIdentifAsistente">Identificación</label>
                  <select name="selecIdentifAsistente" id="selecIdentifAsistente" disabled="disabled">
            ...
            <tr>
              <td style="font-size: medium"><center>
                <strong>Modificar Asistente</strong>
              </center></td>
              <td style="font-size: medium"><form name="form1" method="post" action="">
                <p>
                  <label for="selecIdentifAsistente">Identificación</label>
                  <select name="selecIdentifAsistente" id="selecIdentifAsistente" >
                    <option value="0" selected="selected">Seleccione la Identificacion...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p><label for="textnombreAsistente">Nombre</label>
                  <input name="textnombreAsistente" type="text" id="textnombreAsistente">
                </p>
                <p>      
                  <label for="texttarifaAsistente">Teléfono</label>
                  <input name="texttarifaAsistente" type="text" id="tarifaRuta2">
                </p>
                <p> 
                  <label for="texttarifaAsistente">Dirección</label>
                  <input name="textDireccionAsistente" type="text" id="tarifaRuta">
                </p>
                <p>
                  <label>Fecha de Nacimiento</label>
            ...
            <tr>
              <td style="font-size: medium"><center>
                <strong>                Consultar Asistente
                </strong>
              </center></td>
              <td style="font-size: medium"><form name="form2" method="post" action="">
                <p><label for="selecIdentifAsistente">Identificación</label>
                  <select name="selecIdentifAsistente" id="selecIdentifAsistente" disabled="disabled" readonly ="readonly">
                    <option value="0" selected="selected">Seleccione la Identificacion...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28">
                <p><label for="textnombreAsistente">Nombre</label>
                  <input name="textnombreAsistente" type="text" disabled="disabled" id="textnombreAsistente" readonly>
                </p>
                <p>      
                  <label for="texttarifaAsistente">Teléfono</label>
                  <input name="texttarifaAsistente" type="text" disabled="disabled" id="tarifaRuta2" readonly>
                </p>
                <p> 
                  <label for="texttarifaAsistente">Dirección</label>
                  <input name="textDireccionAsistente" type="text" disabled="disabled" id="tarifaRuta" readonly>
                </p>
                <p>
                  <label>Fecha de Nacimiento</label>
