            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                ...
                <p>
                  ...
                  <input name="textnombRuta" type="text" disabled="disabled" id="nombRuta" readonly="readonly">
                  <input type="image" name="request-Delete" id="frm-request-delete" src="/eliminar.jpg" alt="delete" value="delete" disabled="disabled" readonly="readonly">
                </p>
              </form></td>
            </tr>
            <tr>
