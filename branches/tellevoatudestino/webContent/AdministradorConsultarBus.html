    ...
    <h1><center>
      Administrar Buses
          ...
          <tr>
            ...
            <td><img src="auto3.gif" width="125" height="65"></td>
          </tr>
        </table>
        <hr>
        <p>&nbsp;</p>
        <div>
          <table width="657" cellspacing="2">
            <tr>
              <td width="233" style="font-size: medium"><center>
              Agregar Bus
              </center></td>
              <td width="392" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  <label for="textcodBus">Código Interno Bus</label>
                  <input type="text" name="textcodBus" id="textcodBus">
                </p>
                <p>
                  <label for="textCapacidad">Capacidad</label>
                  <input type="text" name="textCapacidad" id="textCapacidad">
                </p>
                <p><label for="textPlaca">Placa</label> 
                  <input type="text" name="textPlaca" id="textPlaca">
                </p>
                <p>
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                <p>Placa 
                  <select name="selecPlacaBus" id="selecPlacaBus" disabled="disabled" readonly ="readonly">
                    <option value="0" selected="selected">Seleccione la placa...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p>
                  <label for="textCodigoInterno">Código Interno </label>
                  <input name="textCodigoInterno" type="text" disabled="disabled" id="nombRuta" readonly>
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="form1" method="post" action="">
                <p>
                  <label for="selecPlacaBus">Placa</label>
                  <select name="selecPlacaBus" id="selecPlacaBus" disabled="disabled" readonly ="readonly">
                    <option value="0" selected="selected">Seleccione la placa...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p>
                  <label for="textCodInternoBus">Código Interno Bus</label>
                  <input name="textCodInternoBus" type="text" disabled="disabled" id="textCodInternoBus" readonly>
              </p>
                <p>      
                  <label for="textCapacidadBus">Capacidad</label>
                  <input name="textCapacidadBus" type="text" disabled="disabled" id="tarifaRuta2" readonly>
                </p>
                <p>
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="form2" method="post" action="">
                <p>
                  <label for="selecPlacaBus">Placa</label>
                  <select name="selecPlacaBus" id="selecPlacaBus">
                    <option value="0" selected="selected">Seleccione la placa...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p>
                  <label for="textCodInternoBus">Código Interno Bus</label>
                  <input name="textCodInternoBus" type="text" disabled="disabled" id="textCodInternoBus" readonly="readonly">
              </p>
                <p>      
                  <label for="textCapacidadBus">Capacidad</label>
                  <input name="textCapacidadBus" type="text" disabled="disabled" id="tarifaRuta2" readonly="readonly"></p>
                <p>
                  <label for="textComsumo">Consumo de Combustible</label>
                <input name="textComsumo" type="text" disabled="disabled" id="textComsumo" readonly="readonly">
              </p>
              </form></td>
            </tr>
          </table>
