    ...
    <h1><center>
      Administrar Paradas
          ...
          <tr>
            ...
            <td><img src="parada.jpg" width="157" height="115"></td>
          </tr>
        </table>
        <hr>
        <p>&nbsp;</p>
          ...
          <table width="648" border="1" cellspacing="2">
            <tr>
              ...
              <td width="406" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  <label for="textCodParada">Código Parada</label>
                  <input name="textCodParada" type="text" disabled="disabled" id="textIdenficiacionConductor" readonly>
                </p>
                <p>
                  <label for="textnombreparada">Nombre Parada</label>
                  <input name="textnombreparada" type="text" disabled="disabled" id="textnombreparada" readonly>
                </p>
                <p>      
                  <label for="textDireccion">Dirección Parada</label>
            ...
            <tr>
              ...
              <td style="font-size: medium"><form name="eliminarRuta" method="post" action="">
                <p>
                  <label for="selecIdentifAsistente">Cód Parada </label>
                  <select name="selecIdentifAsistente" id="selecIdentifAsistente">
                    <option value="0" selected="selected">Seleccione el Código Parada...</option>
                  </select>
                  <img src="boton_Busqueda.jpg" width="29" height="28" alt="btonbusqueda"></p>
                <p>
                  <label for="textnombreParada">Nombre Parada</label>
                  <input name="textnombreParada" type="text" id="textnombreParada">
