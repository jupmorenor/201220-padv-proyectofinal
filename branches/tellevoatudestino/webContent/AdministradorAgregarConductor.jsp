          ...
          <table width="648" border="1" cellspacing="2">
            <tr>
              ...
              <td width="406" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  <label for="textIdenficiacionConductor">Identificación</label>
                  <input type="text" name="textIdenficiacionConductor" id="textIdenficiacionConductor">
                </p>
                <p>
                  <label for="textnombreConductor">Nombre</label>
                  <input type="text" name="textnombreConductor" id="textnombreConductor">
                </p>
                <p>      
                  <label for="texttarifaRuta">Teléfono</label>
                  <input type="text" name="texttarifaRuta" id="tarifaRuta2">
                </p>
                <p> 
                  <label for="texttarifaRuta">Dirección</label>
                  <input type="text" name="textDireccionConductor" id="tarifaRuta">
                </p>
                <p>
                ...
                <p>
                  ...
                  <input type="text" name="textlicencia" id="textlicencia">
          </p>
                <p>
