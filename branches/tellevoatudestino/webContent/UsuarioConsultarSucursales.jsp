...
<head>
<meta charset="utf-8">
<title>Consultar Sucursal Usuario</title>
<style type="text/css">
<!--
body {
...
.container .content h1 center div table tr td form {
	font-size: medium;
	font-family: Verdana, Arial, Helvetica, sans-serif;
}
-->
...
<div class="container">
  ...
  <div class="content">
    <h1><center>
      <p>Consultar Sucursales </p>
      <form name="form1" method="post" action="">
        <input type="image" name="imageField" id="imageField" src="sucursales.jpg">
      </form>
      <hr>
      <div>
        <p>&nbsp;</p>
        <table width="672" height="372">
          <tr>
            <td width="213" height="268"><form name="form2" method="post" action="">
              Ciudad
