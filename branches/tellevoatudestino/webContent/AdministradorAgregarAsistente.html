            ...
            <tr>
              ...
              <td width="406" style="font-size: medium"><form name="agregarRuta" method="post" action="">
                <p> 
                  ...
                  <input type="text" name="textIdenficiacionAsistente" id="textIdenficiacionConductor">
                </p>
                <p>
                  <label for="textnombreAsistente">Nombre</label>
                  <input type="text" name="textnombreAsistente" id="textnombreAsistente">
                </p>
                <p>      
                  <label for="textTelefono">Teléfono</label>
                  <input type="text" name="textTelefono" id="tarifaRuta2">
                </p>
                <p> 
                  <label for="textDireccion">Dirección</label>
                  <input type="text" name="textDireccion" id="tarifaRuta">
                </p>
                <p>
