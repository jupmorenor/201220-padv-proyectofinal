...
<div class="container">
  ...
  <div class="sidebar1">
    <ul class="nav">
      ...
      <p>
      <li><a href="#"><strong><center>Registrar Información</center></strong></a></li>
    ...
    <h1><center>
      Bienvenidos Usuarios
        ...
        <table width="152" border="1">
          <tr>
            <td><img src="usuarios.jpg" width="144" height="124"></td>
          </tr>
        </table>
        <hr>
        <p><img src="bus_mercedes.jpg" width="348" height="215"></p>
