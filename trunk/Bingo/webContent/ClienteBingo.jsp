...
<div class="container">
  <div class="header"><a href="#"><img src="Bingo_logo.jpg" alt="Insertar logotipo aquí" name="Insert_logo" width="215" height="93" id="Insert_logo" style="display: block;" /><!-- end .header --></div>
  <div class="sidebar1">
    <ul class="nav">
    	<p></p>
