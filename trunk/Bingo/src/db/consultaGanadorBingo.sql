SELECT u.nombreUsuario, b.descBingo, c.descCarton,a.letra, a.numero, d.letra, d.numero
FROM Bingo b, Carton c, balotasCorrectas a, balotas d, personabingo u, tipopersona t
